...
$(MEM_0)_HIERARCHICAL_PATH := SDRAM_VGA
$(MEM_0)_WIDTH := 16
...
.PHONY: SDRAM_VGA
SDRAM_VGA: check_elf_exists $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym

# Memory: onchip_mem3
MEM_1 := Sistema_Epy_onchip_mem3
$(MEM_1)_NAME := onchip_mem3
...
$(MEM_1)_END := 0x0007a97f
$(MEM_1)_SPAN := 0x0003a980
$(MEM_1)_HIERARCHICAL_PATH := onchip_mem3
$(MEM_1)_WIDTH := 32
...
.PHONY: onchip_mem3
onchip_mem3: check_elf_exists $(MEM_INIT_DIR)/$(MEM_1).hex $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym
