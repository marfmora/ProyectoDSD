...
# Memory: onchip_mem2
MEM_0 := Sistema_Epy_onchip_mem2
$(MEM_0)_NAME := onchip_mem2
...
$(MEM_0)_HIERARCHICAL_PATH := onchip_mem2
$(MEM_0)_WIDTH := 32
...
.PHONY: onchip_mem2
onchip_mem2: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym
